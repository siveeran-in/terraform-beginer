...
resource "local_file" "foo" {
  ...
  filename = "C:/Users/SivaNagaRajuVeeranki/Downloads/before kyndryl os installation/courses/terraform/terraform bigginers/Day-3/resourcelocalfile/myoutputfile.txt"
}